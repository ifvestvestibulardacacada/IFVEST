...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var perfilUsuario, nomeUsuario, imagemPerfil, listaAreas;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                */
                ArcanaFlow_js_1.default.action('Revisão', 'Pediu buscar area');
                ...
                return [4 /*yield*/, Area_js_1.default.findAll({
                        attributes: ['id_area', 'nome'],
                        order: [['nome', 'ASC']]
                    })];
            case 1:
                listaAreas = _a.sent();
                res.render('moduloRevisao/buscarArea', { listaAreas: listaAreas, nomeUsuario: nomeUsuario, perfilUsuario: perfilUsuario, imagemPerfil: imagemPerfil });
                return [2 /*return*/];
        }
    });
}); });
