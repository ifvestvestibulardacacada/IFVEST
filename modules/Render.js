    ...
    meusFlashcards: async (req, res) => {
            try {
                ...
                if (perfilUsuario === "PROFESSOR") {
                    res.render('flashcards/professor', { flashcards, nomeUsuario, perfilUsuario, imagemPerfil, id_usuario });
                } else {
        ...
        criarForm: async (req, res) => {
            try {
                ...
                res.render('flashcards/criar', { areas, topicos, dificuldades, nomeUsuario, perfilUsuario, imagemPerfil });
            } catch (error) {
        ...
        editarForm: async (req, res) => {
            try {
                ...
                res.render('flashcards/editar', { flashcard, areas, topicos, dificuldades, nomeUsuario, perfilUsuario, imagemPerfil });
            } catch (error) {
